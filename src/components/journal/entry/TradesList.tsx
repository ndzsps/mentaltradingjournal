...
export const TradesList = ({ trades }: TradesListProps) => {
  console.log('Trades data:', trades); // Debug log to see incoming trade data

  return (
    <Accordion type="single" collapsible className="w-full space-y-2">
      {trades.map((trade, index) => {
        console.log('Processing trade:', trade); // Debug log for each trade
        console.log('Screenshots:', trade.screenshots); // Debug log for screenshots
        console.log('URL:', trade.url); // Debug log for URL
